...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
    <div class="container">
        <!-- Logo and Brand Name -->
        <a href="index.php" class="navbar-brand" style="font-family: 'Playfair Display', serif;">
            <img src="images/logo.jpg" alt="SMU MediEssential Logo" style="height: 40px; margin-right: 10px;">
            SMU MediEssential
        </a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="products.php#stethoscope" class="dropdown-item">Stethoscopes</a>
                        <a href="products.php#scrubs" class="dropdown-item">Scrubs</a>
                        <a href="products.php#labcoats" class="dropdown-item">Lab Coats</a>
                        <a href="products.php#masks" class="dropdown-item">Masks</a>
                        <a href="products.php#gloves" class="dropdown-item">Gloves</a>
                    </div>
                </li>
...
<!-- Add Google Fonts link for Playfair Display -->
